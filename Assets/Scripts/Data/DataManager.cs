...
//		CreateCompanyData();
	...
	CompanyModel CreateCompanyData ()
	{
		...
		employers.Add (FireBaseManager.GetFireBaseInstance ().CreateNewResponsableToCompany (companyData.userID, "Funcionario 1", new List<ServicesProvidedModel> { servicesList [0] }));
		employers.Add (FireBaseManager.GetFireBaseInstance ().CreateNewResponsableToCompany (companyData.userID, "Funcionario 2", new List<ServicesProvidedModel> { servicesList [1] }));
		employers.Add (FireBaseManager.GetFireBaseInstance ().CreateNewResponsableToCompany (companyData.userID, "Funcionario 3", new List<ServicesProvidedModel> { servicesList [2] }));
		employers.Add (FireBaseManager.GetFireBaseInstance ().CreateNewResponsableToCompany (companyData.userID, "Funcionario 4", servicesList));
