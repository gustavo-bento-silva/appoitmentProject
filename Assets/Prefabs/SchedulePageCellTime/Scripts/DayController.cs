...
public class DayController : MonoBehaviour
{
	...
	public void OnCellClick()
	{
		...
		if (DataManager.currentUser.userType == Constants.UserType.Anonymous.ToString())
		{
			var popup = pageNav.GetPagePrefabByEnum(PagesEnum.LoginPopup);
			pageNav.OpenModal(popup);
			return;
		}
